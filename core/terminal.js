...
(function(){
  ...
  function init()
  {
    ...
    <div style="max-width:400px;margin:auto;">
      <p style="text-align:center"><a href="http://www.thewandcompany.com" target="_blank"><img src="https://thewandcompany.com/images/logos/Asset_1wand_co_logo.png" width="320" height="262" alt="The Wand Company"/></a></p>
      <p id="versioninfo" style="text-align:right"></p>
      <p style="text-align:center">Code Editor and Terminal for Project Dickens development</p>
      </div>`;
    }
